...
/root/.acme.sh/acme.sh --issue -d test.seras.my.id --standalone -k ec-256
/root/.acme.sh/acme.sh --installcert -d test.seras.my.id --fullchainpath /usr/local/etc/xray/xray.crt --keypath /usr/local/etc/xray/xray.key --ecc
